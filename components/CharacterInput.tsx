...
import { Upload, Sparkles, Loader2, Trash2, Wand2, Download, Mic } from 'lucide-react';
...
const CharacterInput: React.FC<CharacterInputProps> = ({
  ...
  const handleGenerateImage = async () => {
    ...
    try {
      const base64Image = await generateCharacterImage(character, styleId);
      ...
      <div className="space-y-3">
        ...
        <div>
          <div className="flex justify-between items-center mb-1">
             <label className="block text-xs font-medium text-slate-500">Mô tả ngoại hình (cho AI tạo ảnh)</label>
          </div>
